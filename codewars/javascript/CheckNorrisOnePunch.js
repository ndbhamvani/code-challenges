...
of the letters 'e' and 'a' removed - why, you ask? Well Nunchuks hasn't got the letters 'a' or 'e' in it has it??
...
const onePunch = s => Number.isInteger(s) || s == "" || Array.isArray(s) ? 'Broken!' : s.split(' ').sort().join(' ').replace(/[ae]/gi, '')
